...
function AboutPage() {
  ...
  return <MainLayout title="Sobre Mí" description="Conoce a Brenda Belen, desarrolladora web apasionada por crear soluciones digitales innovadoras en BrenStudio.">
        ...
        <div className="container mx-auto">
          ...
          duration: 0.8
            ...
            delay: 0.2
              ...
              <div className="relative">
                <img src="https://horizons-cdn.hostinger.com/3f93707d-78c2-4aa4-97e6-02625c623c2b/3094c7c910252599fd9c1ba874eb4e16-65evZ.jpg" alt="Brenda Belen" className="rounded-2xl shadow-2xl w-full h-[500px] object-cover" />
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-pink-400/20 to-purple-400/20"></div>
              </div>
            </motion.div>
            ...
            delay: 0.4
              ...
              <h1 className="text-4xl md:text-5xl font-bold gradient-text font-poppins">Hola, soy Brenda Belen</h1>
              ...
              }].map((item, index) => <motion.div key={index} className="flex flex-col items-center text-center" whileHover={{
                scale: 1.1
              }}>
          ...
          <div className="mb-20">
            ...
            duration: 0.6
              ...
              {skills.map((skill, index) => <motion.div key={index} className="px-6 py-3 glass-effect rounded-full font-semibold text-gray-700" initial={{
              opacity: 0,
              scale: 0.5
            }} whileInView={{
              opacity: 1,
          ...
          <div>
            ...
            <div className="mt-12 max-w-3xl mx-auto">
              {timeline.map((item, index) => <motion.div key={index} className="relative pl-8 pb-12 border-l-2 border-purple-300 last:pb-0" initial={{
              opacity: 0,
              x: -50
            }} whileInView={{
              opacity: 1,
